...
function Home(){
    ...
    <div className="row">
      <div className='logo'>
            ...
            <img src="https://media.licdn.com/dms/image/C4D03AQHWaMz8xN5LQg/profile-displayphoto-shrink_800_800/0/1662729843355?e=1706140800&v=beta&t=PANqjm3FcJ9d8DLXuXYw5GN8Ioxun8oYGfMqEQMIiF0" alt="Sample Image" style={{ position: 'absolute', top: '80', right: '15%', width: '200px', height: '200px' }}/>
            </div>
            </div>
    </div>
    <div className="row" >
    ...
    <div className='row'>
        <div className='text' style={{marginTop:'2%'}}>
            <p style={{textAlign:'left',marginTop:'2%',marginBottom:'2%'}}>Computer Engineering Student from K.J. Somaiya College of Engineering. Interest on problem solving and analysing data and website development.
